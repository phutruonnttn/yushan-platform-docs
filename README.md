...
http://youtube.com/watch?v=0dc7Z0p1V4E
...
- Deployment: 
  - **Backend**: Digital Ocean (Terraform), Docker
...
- **Backend Deployment**: Railway → Digital Ocean (Terraform)
...
- **Frontend Changes**: Only backend API endpoint configuration updated
